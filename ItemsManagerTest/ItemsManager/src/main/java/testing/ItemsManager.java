...
public class ItemsManager {
    ...
    private String Absolute_path = "/home/ilya/Desktop/apache-tomcat-9.0.65/webapps/CourseServlet/";
    ...
    public synchronized void readFile() throws Exception{
        String path = "/home/ilya/Desktop/CourseServletFiles/Items.txt";
        ...
        if(list.length() != 0) {
            ...
            String path1 = "/home/ilya/Desktop/CourseServletFiles/IdNumbers.txt";
            ...
            String path3 = "/home/ilya/Desktop/CourseServletFiles/FilePaths.txt";
    ...
    public synchronized void SaveImage(InputStream fileContent, String name) throws Exception{
        FileOutputStream fout = new FileOutputStream(new File(Absolute_path + DirPath + name));
        int read = 0;
